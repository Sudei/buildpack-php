...
apt-get install -y -qq libxml2-dev libpng-dev libicu-dev libxslt-dev libcurl4-openssl-dev pkg-config libjpeg-dev libfreetype6-dev libmcrypt-dev freetds-dev libbz2-dev libpq-dev libreadline-dev autoconf imagemagick git libtool s3cmd libmagickwand-dev libsasl2-dev
